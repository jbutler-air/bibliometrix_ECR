...
conceptualStructure<-function(M,field="ID", ngrams=1, method="MCA", quali.supp=NULL, quanti.supp=NULL, minDegree=2, 
  ...
  cbPalette <- c(RColorBrewer::brewer.pal(9, 'Set1')[-6], RColorBrewer::brewer.pal(8, 'Set2')[-7], RColorBrewer::brewer.pal(12, 'Paired')[-11],RColorBrewer::brewer.pal(12, 'Set3')[-c(2,8,12)])
